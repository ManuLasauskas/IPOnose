...
public class Agente {
	...
	private void InicializarDatos() {
		...
		p1.AnadirTarea(new Tarea("Prototipar modelo interaccion",init.getTime(),end.getTime(),Prioridad.MEDIA));
		
		init.set(2017,10,2,9,0,0);
		end.set(2017,12,28,15,0,0);
		p1.AnadirTarea(new Tarea("Integracion en dispositivos",init.getTime(),end.getTime(),Prioridad.MEDIA));
		...
		p2.AnadirTarea(new Tarea("Diseño nuevo firewall",init.getTime(),end.getTime(),Prioridad.MAXIMA));
		
		init.set(2018,9,2,9,0,0);
		end.set(2018,11,28,14,0,0);
		p2.AnadirTarea(new Tarea("Revision modelo de comunicacion",init.getTime(),end.getTime(),Prioridad.MEDIA));
